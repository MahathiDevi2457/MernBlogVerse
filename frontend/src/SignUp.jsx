        ...
        <div className="flex flex-col items-center mt-7 gap-5">
            ...
            <form className="flex flex-col border-gray-700 border-1 w-1/4 py-10 items-center gap-5 rounded-2xl">
                <div className="flex flex-col gap-2 w-[90%]">
                    ...
                    <input type="text" placeholder="Enter your Full Name" className="border-1 border-gray-700 w-full py-2 px-3 rounded-xl focus:outline-none focus:border-indigo-200" />
                </div>
                <div className="flex flex-col gap-2 w-[90%]">
                    <p className="font-semibold text-md text-gray-700" >Email ID</p>
                    <input type="text" placeholder="Enter your Email ID" className="border-1 border-gray-700 w-full py-2 px-3 rounded-xl focus:outline-none focus:border-indigo-200" />
                </div>
                <div className="flex flex-col gap-2 w-[90%]">
                    <p className="font-semibold text-md text-gray-700" >Password</p>
                    <input type="text" placeholder="Enter password" className="border-1 border-gray-700 w-full py-2 px-3 rounded-xl focus:outline-none focus:border-indigo-200" />
                </div>
                <div className="flex flex-col gap-2 w-[90%]">
                    <p className="font-semibold text-md text-gray-700" >Confirm Password</p>
                    <input type="text" placeholder="Confirm your password" className="border-1 border-gray-700 w-full py-2 px-3 rounded-xl focus:outline-none focus:border-indigo-200" />
